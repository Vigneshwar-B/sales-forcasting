...
MONGO_URL="mongodb+srv://vigneshwar:ISNHMWuKEJzrPy8n@dbname.2ltq6e7.mongodb.net/?retryWrites=true&w=majority"
...
def postPrediction(email):
    ...
    if request.method=="POST":
        ...
        # print(validation)
        #SARIMA MODEL
        mod =ARIMA(new_data,order=(1, 1, 1),seasonal_order=(1, 1, 1, 12),enforce_invertibility=False)
        results = mod.fit()
